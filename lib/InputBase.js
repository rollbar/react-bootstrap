...
var InputBase = (function (_React$Component) {
  ...
  _createClass(InputBase, [{
    ...
    value: function renderInputGroup(children) {
      var addonBeforeClasses = (0, _classnames2['default'])(this.props.addonBeforeClasses);
      var addonBefore = this.props.addonBefore ? _react2['default'].createElement(
        'span',
        { className: addonBeforeClasses, key: 'addonBefore' },
        this.props.addonBefore
      ) : null;

      var addonAfterClasses = (0, _classnames2['default'])(this.props.addonAfterClasses);
      var addonAfter = this.props.addonAfter ? _react2['default'].createElement(
        'span',
        { className: addonAfterClasses, key: 'addonAfter' },
    ...
    value: function renderChildren() {
      return !this.isCheckboxOrRadio() ? [this.renderLabel(), this.renderWrapper([this.props.helpPosition === 'top' ? this.renderHelp() : null, this.renderInputGroup(this.renderInput()), this.renderIcon(), this.props.helpPosition === 'bottom' ? this.renderHelp() : null])] : this.renderWrapper([this.renderCheckboxAndRadioWrapper(this.renderLabel(this.renderInput())), this.renderHelp()]);
    }
  }, {
    key: 'render',
...
InputBase.propTypes = {
  ...
  helpPosition: _react2['default'].PropTypes.string,
  addonBefore: _react2['default'].PropTypes.node,
  addonBeforeClasses: _react2['default'].PropTypes.any,
  addonAfter: _react2['default'].PropTypes.node,
  addonAfterClasses: _react2['default'].PropTypes.any,
